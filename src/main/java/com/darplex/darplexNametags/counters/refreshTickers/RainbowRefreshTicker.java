...
public class RainbowRefreshTicker extends RefreshTicker {
    public RainbowRefreshTicker(@NotNull DarplexNametags plugin, @NotNull RefreshTask refreshTask, @NotNull Long delay, @NotNull Long period) {
